extensions [ nw ]
globals [colour counter node2-list existing-connections existing-paths]
...
to setup-manager-links
    ...
    [
      ...
      let node1  self
      set node2-list  ( n-of (T - 1) other turtles with[manager? = 1])
...
<experiments>
  ...
  <experiment name="experiment-3-order-reversed" repetitions="1" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="200"/>
    <metric>2 * (count links) / (count turtles)</metric>
  ...
  <experiment name="experiment-4" repetitions="1" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="200"/>
    <metric>2 * (count links) / (count turtles)</metric>
    <steppedValueSet variable="add-people" first="1" step="2" last="20"/>
    <steppedValueSet variable="Rate-of-connection" first="0.3" step="0.05" last="0.7"/>
  ...
  <experiment name="experiment-7" repetitions="1" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="150"/>
    <metric>Degree-of-Separation</metric>
